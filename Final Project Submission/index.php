...
">
              ...
              <li class="sign col-2" style=" padding-left: 50px;
  margin-top: 10px;
">
                  ...
                  <?php else: ?>
                     <a href="logout.php" style="width:auto;  padding-left: 20px; padding-right: 20px; padding-bottom: 10px; padding-top: 10px;">Logout</a>
                  <?php endif; ?>
